<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RID.aspx.vb" Inherits="RID" %>
...
<td class="style22"  padding: 15px;">
    <asp:TextBox ID="TextBox1" runat="server" Height="40px" Width="244px"></asp:TextBox>
</td>
</tr>
<tr>
<td class="style43" 
...
<td class="style44" style="color: #FFFFFF">
    <asp:TextBox ID="TextBox2" runat="server" Height="38px" Width="244px"></asp:TextBox></td>
</tr>
<tr>
<td class="style33" 
...
<td class="style34">
    <asp:TextBox ID="TextBox3" runat="server" 
        TextMode="Password" Height="43px" Width="242px"></asp:TextBox>
</td>
</tr>
<tr>
<td class="style35" 
