...
<head runat="server">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>IKSIA EVENTS- A PERFECT PARTY!!</title>  
...
<body id="home" data-spy="scroll" data-target="#navbar-wd" data-offset="98">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="catergory.aspx">Services</a></li>
	...
	<div class="home-slider">
		...
		<div class="lbox-details">
			<h1>DHRUV RAJPOOT WEDS ANURADHA SINGH</h1>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 text-center">
						<div class="title-box">
							<h2>DHRUV RAJPOOT & ANURADHA SINGH</h2>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12">
						<div class="row align-items-center about-main-info">
							...
							<div class="col-lg-8 col-md-6 col-sm-12">
								<h2> <i class="fa fa-heart-o" aria-hidden="true"></i> ANURADHA SINGH</h2>
						...
						<div class="row align-items-center about-main-info">
							...
							<div class="col-lg-8 col-md-6 col-sm-12">
								<h2> <i class="fa fa-heart-o" aria-hidden="true"></i> DHRUV RAJPOOT</h2>
			...
			<div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="serviceBox">
                        ...
                        <p class="description">
                           TIME:-9:00PM
                            VENUE:-THE GRAND RAMA CEREMONIAL
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="title-box">
						...
						<p>A great marriage is not when the perfect couple comes together. It is when an imperfect couple learns to enjoy their differences. </p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
						...
						<h2>2 JUNE 2022 Engagement</h2>
                        <p></p>
                        <a href="catergory.aspx">DETAILS>> <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
	
						<p> </p>
						<a href="https://goo.gl/maps/3m5qX8xPL52CTnvR7">See location <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
				</div>
				</div>
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="event-inner">
						...
						<h2>7 June 2022 Reception party </h2>
                        <p></p>
					  ...
					  <div class="row">
						<div class="col-md-6">
							<div class="form-group">
                                <asp:TextBox ID="TextBox1" runat="server" Width="543px" BackColor="#990033" 
                                    Font-Size="Medium" ForeColor="White">PLEASE ENTER YOUR NAME</asp:TextBox>
								<div class="help-block with-errors"></div>
							</div>                                 
						</div>
						<div class="col-md-6">
							<div class="form-group">
                                <asp:TextBox ID="TextBox2" runat="server" Width="543px" BackColor="#990033" 
                                    Font-Size="Medium" ForeColor="White" TextMode="Email">PLEASE ENTER YOUR E-MAIL</asp:TextBox>
								<div class="help-block with-errors"></div>
							</div> 
						</div>
						<div class="col-md-6">
							<div class="form-group">
                                <asp:DropDownList ID="DropDownList1" runat="server" Height="25px" Width="541px" 
                                    BackColor="#990033" Font-Size="Medium" ForeColor="White">
                                    <asp:ListItem>NO. OF ATTENDEES</asp:ListItem>
						...
						<div class="col-md-6">
							<div class="form-group">
                                <asp:DropDownList ID="DropDownList2" runat="server" Height="25px" Width="540px" 
                                    BackColor="#990033" Font-Size="Medium" ForeColor="White">
                                    <asp:ListItem>I AM ATTENDING</asp:ListItem>
						...
						<div class="col-md-12">
							<div class="form-group"> 
                                <asp:TextBox ID="TextBox3" runat="server" Height="121px" Width="1117px" 
                                    BackColor="#990033" Font-Size="Medium" ForeColor="White" 
                                    TextMode="MultiLine">WRITE YOUR MESSAGE</asp:TextBox>
								<div class="help-block with-errors"></div>
							</div>
							<div class="submit-button text-center">
                                <asp:Button ID="Button1" runat="server" Text="SEND MESSAGE" BackColor="#990033" 
                                    ForeColor="White" Height="53px" Width="191px" /> 
